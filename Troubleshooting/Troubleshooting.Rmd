...
```{r warning=FALSE}
source("Mixed-models/Function library/function_library.R", local = knitr::knit_global())
source("Mixed-models/Function library/generate_family_data.R", local = knitr::knit_global())
source("Mixed-models/ML/ml_fisher_scoring_algorithm.R", local = knitr::knit_global())
source("Mixed-models/REML/reml_fisher_scoring_algorithm.R", local = knitr::knit_global())
```
...
family_dataset <- family_dataset_generator(n_clusters = n_clusters, n_individuals_in_cluster = n_individuals_in_cluster,
                                           n_mean_param = 1, mean_val = 1, beta_1 = 5,
...
```{r}
init_params <- c(1,1,1)
small_value_threshold = 1e-32
add_small_constant = 1e-18
